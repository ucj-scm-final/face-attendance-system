            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="index.html"><i class="feather-grid"></i> <span> Dashboard</span> <span
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fas fa-graduation-cap"></i> <span> Students</span> <span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="{{ url("/student-registrations") }}">Student List</a></li>
                                <li><a href="{{ url("student-registrations/create") }}">Student Add</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fas fa-user-check"></i> <span> Attendance</span> <span
                                    class="menu-arrow"></span></a>
                            <ul>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fas fa-camera"></i> <span> Train Face</span> <span
                                    class="menu-arrow"></span></a>                            
                        </li>
